    ...
    <div className="flex-1 w-full animate-fade-in font-display">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        <div className="flex flex-col gap-2">
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-slate-100">Risk Overview</h1>
          <div className="flex items-center gap-2 text-slate-400 text-sm">
            <span className="material-symbols-outlined text-[18px]">person</span>
            <p>Patient ID: <span className="font-mono text-slate-300">{result.patient_id || "PT-49202-X"}</span></p>
            <span className="mx-2 opacity-50">|</span>
            <p>CPIC Drug: <span className="font-mono text-[#13b6ec]">{result.drug}</span></p>
          </div>
        </div>
            ...
            <div className="p-8 relative z-10">
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-center gap-3">
                  <div className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider flex items-center gap-2 border ${isHighRisk ? 'bg-red-500/10 text-red-500 border-red-500/20' : 'bg-[#13b6ec]/10 text-[#13b6ec] border-[#13b6ec]/20'}`}>
                    ...
                    {isHighRisk ? 'High Priority Alert' : 'Standard Advisory'}
                  </div>
                </div>
              ...
              <div className="flex flex-col md:flex-row gap-8 items-start">
                <div className="flex-1">
                  <h2 className="text-3xl font-bold text-white mb-4">{result.risk_assessment.risk_label} Detected</h2>
              ...
              <div className="mt-8 pt-6 border-t border-[#283539] flex justify-between items-center">
                <span className="text-sm text-slate-500">Confidence Score: {(result.risk_assessment.confidence_score * 100).toFixed(1)}%</span>
            ...
            <div className="mt-6">
              <div className="w-full bg-[#142227] h-64 rounded-lg relative overflow-hidden group">
                ...
                <div className="absolute top-4 left-4">
                  <span className="text-xs font-bold uppercase tracking-wider text-slate-500">Projected Drug Exposure Levels</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-5 xl:col-span-4 flex flex-col gap-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2 bg-[#18282e] p-5 rounded-xl border border-[#283539] flex flex-col justify-between hover:border-[#13b6ec]/50 transition-colors group">
              <div className="flex justify-between items-start mb-2">
                <p className="text-sm font-medium text-slate-500">Phenotype Classification</p>
          ...
          <div className="bg-[#18282e] rounded-xl border border-[#283539] overflow-hidden flex-1">
            <div className="p-4 border-b border-[#283539] bg-[#142227] flex justify-between items-center">
              <h3 className="font-bold text-slate-100 text-sm">Genomic Details</h3>
